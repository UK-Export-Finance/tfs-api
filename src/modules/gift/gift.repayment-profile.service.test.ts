  ...
  describe('createOne', () => {
    ...
    it('should call giftHttpService.post', async () => {
      ...
      expect(mockHttpServicePost).toHaveBeenCalledWith({
        path: `${PATH.FACILITY}/${mockFacilityId}${PATH.WORK_PACKAGE}/${mockWorkPackageId}${PATH.CONFIGURATION_EVENT}/${EVENT_TYPES.ADD_MANUAL_REPAYMENT_PROFILE}`,
    ...
    describe('when giftHttpService.post returns an error', () => {
      ...
      it('should thrown an error', async () => {
        ...
        // Assert
        const expected = new Error(`Error creating a repayment profile for facility ${mockFacilityId}`);
