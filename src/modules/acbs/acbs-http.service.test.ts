...
describe('AcbsHttpService', () => {
  ...
  describe('getRequest', () => {
    ...
    it.each([
      {
        useReturnExceptionHeader: true,
        expectedHttpServiceArgs: expectedHttpServiceGetArgsWithReturnException,
        description: 'with the ReturnException header set to true',
      },
  ...
  describe('postRequest', () => {
    ...
    it.each([
      {
        useReturnExceptionHeader: true,
        expectedHttpServiceArgs: expectedHttpServicePostArgsWithReturnException,
        description: 'with the ReturnException header set to true',
      },
  ...
  describe('putRequest', () => {
    ...
    it.each([
      {
        useReturnExceptionHeader: true,
        expectedHttpServiceArgs: expectedHttpServicePutArgsWithReturnException,
        description: 'with the ReturnException header set to true',
      },
