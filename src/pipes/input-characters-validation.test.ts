...
describe('InputCharacterValidationPipe', () => {
  ...
  describe('transform', () => {
    describe('Validate that error is thrown when query param dto has unsupported characters', () => {
    ...
    describe('Validate that error is thrown when URL param dto has unsupported characters', () => {
    ...
    describe('Validate that error is thrown when body param dto has unsupported characters', () => {
    ...
    describe('Validate that no error is thrown when supported characters are used', () => {
