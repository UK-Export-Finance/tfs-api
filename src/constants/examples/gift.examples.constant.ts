...
const FACILITY_ID_2: UkefId = '0030000322';
const FACILITY_ID_3: UkefId = '0030000323';

const FACILITY_IDS_QUERY_PARAM = `${FACILITY_ID},${FACILITY_ID_2},${FACILITY_ID_3}`;

const ACCRUAL_SCHEDULE_ID = 123;

const OBLIGATION_ID = 456;

const REPAYMENT_PROFILE_ID = 789;
...
const ACCRUAL_SCHEDULE_WITHOUT_INDEX_RATE_CODE = BASE_ACCRUAL_SCHEDULE;

const ACCRUAL_SCHEDULE_WITHOUT_OPTIONAL_DATES = BASE_ACCRUAL_SCHEDULE;
 ...
 * Fully populated facility creation data in the shape that APIM TFS requires.
 */
...
/**
 * FACILITY_CREATION_PAYLOAD_WITH_FIXED_RATE_ACCRUAL_SCHEDULES
 * Facility creation payload with accrual schedules without indexRateCode (fixed rate schedules).
 */
const FACILITY_CREATION_PAYLOAD_WITH_FIXED_RATE_ACCRUAL_SCHEDULES: GiftFacilityCreationRequestDto = {
  consumer: CONSUMER.DTFS,
  overview: FACILITY_OVERVIEW,
  accrualSchedules: [ACCRUAL_SCHEDULE_WITHOUT_INDEX_RATE_CODE, ACCRUAL_SCHEDULE_WITHOUT_INDEX_RATE_CODE],
  counterparties: [COUNTERPARTY(), COUNTERPARTY()],
  fixedFees: [FIXED_FEE(), FIXED_FEE()],
  obligations: [OBLIGATION(), OBLIGATION()],
  repaymentProfiles: [
...
/**
 * FACILITY_CREATION_PAYLOAD_WITHOUT_OPTIONAL_ACCRUAL_DATES
 * Facility creation payload with accrual schedules without optional date fields.
 */
const FACILITY_CREATION_PAYLOAD_WITHOUT_OPTIONAL_ACCRUAL_DATES: GiftFacilityCreationRequestDto = {
  ...FACILITY_CREATION_PAYLOAD_WITH_FIXED_RATE_ACCRUAL_SCHEDULES,
  accrualSchedules: [ACCRUAL_SCHEDULE_WITHOUT_OPTIONAL_DATES, ACCRUAL_SCHEDULE_WITHOUT_OPTIONAL_DATES],
};
...
const FACILITY_MULTIPLE_AMENDMENTS_REQUEST_PAYLOAD = {
  amendments: [FACILITY_AMENDMENT_REQUEST_PAYLOAD, FACILITY_AMENDMENT_REQUEST_PAYLOAD, FACILITY_AMENDMENT_REQUEST_PAYLOAD],
};
...
export const GIFT_EXAMPLES = {
  ACCRUAL_SCHEDULE,
  ACCRUAL_SCHEDULE_WITHOUT_INDEX_RATE_CODE,
  ACCRUAL_SCHEDULE_WITHOUT_OPTIONAL_DATES,
  ACCRUAL_SCHEDULE_ID,
  BUSINESS_CALENDAR,
  ...
  FACILITY_MULTIPLE_AMENDMENTS_REQUEST_PAYLOAD,
  FACILITY_ID,
  FACILITY_ID_2,
  FACILITY_ID_3,
  FACILITY_IDS_QUERY_PARAM,
  FACILITY_OVERVIEW,
  FACILITY_RESPONSE_DATA,
  FEE_TYPES,
