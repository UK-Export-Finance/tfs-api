...
export class GetFacilityLoanTransactionGenerator extends AbstractGenerator<FacilityLoanTransactionValues, GenerateResult, GenerateOptions> {
  ...
  protected generateValues(): FacilityLoanTransactionValues {
    ...
    return {
      ...
      operationTypeCode: this.valueGenerator.enumValue<OperationTypeCodeEnum>(OperationTypeCodeEnum),
      ...
      productGroupCode: this.valueGenerator.enumValue<ProductTypeGroupEnum>(ProductTypeGroupEnum),
      productTypeCode: this.valueGenerator.enumValue<ProductTypeIdEnum>(ProductTypeIdEnum),
