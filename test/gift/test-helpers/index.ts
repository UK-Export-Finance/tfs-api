...
export const apimFacilityMultipleAmendmentsWithoutQueueUrl = `/api/${prefixAndVersion}/gift${PATH.FACILITY}/${mockFacilityId}/multiple-amendments/without-queue`;
...
export const accrualScheduleFixedRateUrl = `${PATH.FACILITY}/${mockFacilityId}${PATH.WORK_PACKAGE}/${mockWorkPackageId}${PATH.CONFIGURATION_EVENT}/${EVENT_TYPES.ADD_ACCRUAL_SCHEDULE_FIXED_RATE}`;
export const accrualScheduleIndexedRateUrl = `${PATH.FACILITY}/${mockFacilityId}${PATH.WORK_PACKAGE}/${mockWorkPackageId}${PATH.CONFIGURATION_EVENT}/${EVENT_TYPES.ADD_ACCRUAL_SCHEDULE_INDEXED_RATE}`;
