    ...
    it(`should return a ${HttpStatus.BAD_REQUEST} response with validation errors`, async () => {
      ...
      const expected = {
        ...
        message: [
          ...
          'accrualSchedules should not be null or undefined',
          'accrualSchedules should not be empty',
          'accrualSchedules must be an array',
    ...
    it(`should return a ${HttpStatus.BAD_REQUEST} response with validation errors for all required fields`, async () => {
      ...
      const expected = {
        ...
        message: [
          ...
          'accrualSchedules should not be empty',
          'accrualSchedules must be an array',
          'nested property accrualSchedules must be either object or array',
          'counterparties should not be null or undefined',
          'counterparties should not be empty',
          'counterparties must be an array',
    ...
    it(`should return a ${HttpStatus.BAD_REQUEST} response with validation errors for all required fields`, async () => {
      ...
      const expected = {
        ...
        message: [
          ...
          'accrualSchedules.accrualDayBasisCode should not be null or undefined',
          `accrualSchedules.accrualDayBasisCode must be longer than or equal to ${VALIDATION.ACCRUAL_SCHEDULE.ACCRUAL_DAY_BASIS_CODE.MIN_LENGTH} characters`,
          'accrualSchedules.accrualDayBasisCode must be a string',
          'accrualSchedules.accrualEffectiveDate should not be null or undefined',
          'accrualSchedules.accrualEffectiveDate must be a valid ISO 8601 date string',
          'accrualSchedules.accrualFrequencyCode should not be null or undefined',
          `accrualSchedules.accrualFrequencyCode must be longer than or equal to ${VALIDATION.ACCRUAL_SCHEDULE.ACCRUAL_FREQUENCY_CODE.MIN_LENGTH} characters`,
          'accrualSchedules.accrualFrequencyCode must be a string',
          'accrualSchedules.accrualMaturityDate should not be null or undefined',
          'accrualSchedules.accrualMaturityDate must be a valid ISO 8601 date string',
          'accrualSchedules.accrualScheduleTypeCode should not be null or undefined',
          `accrualSchedules.accrualScheduleTypeCode must be longer than or equal to ${VALIDATION.ACCRUAL_SCHEDULE.ACCRUAL_SCHEDULE_TYPE_CODE.MIN_LENGTH} characters`,
          'accrualSchedules.accrualScheduleTypeCode must be a string',
          'accrualSchedules.additionalRate should not be null or undefined',
          `accrualSchedules.additionalRate must not be less than ${VALIDATION.ACCRUAL_SCHEDULE.ADDITIONAL_RATE.MIN}`,
          'accrualSchedules.additionalRate must be a number conforming to the specified constraints',
          'accrualSchedules.baseRate should not be null or undefined',
          'accrualSchedules.baseRate must be a number conforming to the specified constraints',
          'accrualSchedules.firstCycleAccrualEndDate should not be null or undefined',
          'accrualSchedules.firstCycleAccrualEndDate must be a valid ISO 8601 date string',
          'accrualSchedules.spreadRate should not be null or undefined',
          `accrualSchedules.spreadRate must not be less than ${VALIDATION.ACCRUAL_SCHEDULE.SPREAD_RATE.MIN}`,
          'accrualSchedules.spreadRate must be a number conforming to the specified constraints',
