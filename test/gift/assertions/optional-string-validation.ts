...
/**
 * Validation tests for a nested, optional string field with invalid values
 ...
 */
export const optionalStringValidation = ({ fieldName, initialPayload, min, max, parentFieldName, url }) => {
  let api: Api;
