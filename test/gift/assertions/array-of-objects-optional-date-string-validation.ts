...
/**
 * Validation tests for an array of objects - optional date string field with invalid values
 * @param {string} fieldName: The name of a field. E.g, effectiveDate
 * @param {object} initialPayload: The payload to use before adding a field value
 * @param {string} parentFieldName: The name of a parent field. E.g parentObject
 * @param {string} url: The URL the tests will call.
 */
export const arrayOfObjectsOptionalDateStringValidation = ({ fieldName, initialPayload, parentFieldName, url }) => {
  let api: Api;
