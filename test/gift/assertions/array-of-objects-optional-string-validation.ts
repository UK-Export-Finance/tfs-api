...
/**
 * Validation tests for an array of objects - optional string field with invalid values
 ...
 */
export const arrayOfObjectsOptionalStringValidation = ({ fieldName, initialPayload, min, max, parentFieldName, url }) => {
  let api: Api;
