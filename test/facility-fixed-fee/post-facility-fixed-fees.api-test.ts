...
describe('POST /facilities/{facilityIdentifier}/fixed-fees', () => {
  ...
  //   it('sets FixedFeeName to CHARGEABLE AMOUNT if fixedFeeType is 47', async () => {
  //     givenRequestToGetFacilityFromAcbsSucceeds();
  //     const facilityFixedFeeWithType47: CreateFacilityFixedFeeRequest = [
  //       {
  //         ...requestBodyToCreateFacilityFixedFee[0],
  //         fixedFeeType: '47',
  //       },
  //     ];
  //     const acbsRequestBodyWithExpectedFixedFeeName = {
  //       ...acbsRequestBodyToCreateFacilityFixedFee,
  //       FixedFeeName: 'CHARGEABLE AMOUNT',
  //       FixedFeeType: { FixedFeeTypeCode: '47' },
  //     };
  //     const acbsRequestWithExpectedFixedFeeName = requestToCreateFacilityFixedFeeInAcbsWithBody(acbsRequestBodyWithExpectedFixedFeeName).reply(201);

  //     const { status, body } = await api.post(createFacilityFixedFeeUrl, facilityFixedFeeWithType47);

  //     expect(status).toBe(201);
  //     expect(body).toStrictEqual({
  //       facilityIdentifier,
  //     });
  //     expect(acbsRequestWithExpectedFixedFeeName.isDone()).toBe(true);
  //   });

  //   it('sets FixedFeeName to AMOUNT OF SUPPORTED BOND if fixedFeeType is 43 and facilityTypeCode is 250', async () => {
  ...
  //     const facilityFixedFeeWithType43: CreateFacilityFixedFeeRequest = [
  //       {
  //         ...requestBodyToCreateFacilityFixedFee[0],
  //         fixedFeeType: '43',
  //       },
  ...
  //     const acbsRequestBodyWithExpectedFixedFeeName = {
  //       ...acbsRequestBodyToCreateFacilityFixedFee,
  //       FixedFeeName: 'AMOUNT OF SUPPORTED BOND',
  //       FixedFeeType: { FixedFeeTypeCode: '43' },
  //     };
  //     const acbsRequestWithExpectedFixedFeeName = requestToCreateFacilityFixedFeeInAcbsWithBody(acbsRequestBodyWithExpectedFixedFeeName).reply(201);

  //     const { status, body } = await api.post(createFacilityFixedFeeUrl, facilityFixedFeeWithType43);
  ...
  //   it('sets FixedFeeName to AMOUNT OF SUPPORTED FACILITY if fixedFeeType is 43 and if facilityTypeCode is 260', async () => {
  ...
  //     const acbsRequestBodyWithExpectedFixedFeeName = {
  //       ...acbsRequestBodyToCreateFacilityFixedFee,
  //       FixedFeeName: 'AMOUNT OF SUPPORTED FACILITY',
  //       FixedFeeType: { FixedFeeTypeCode: '43' },
  //     };
  //     const acbsRequestWithExpectedFixedFeeName = requestToCreateFacilityFixedFeeInAcbsWithBody(acbsRequestBodyWithExpectedFixedFeeName).reply(201);
  ...
  //   it('sets FixedFeeName to AMOUNT OF SUPPORTED FACILITY if fixedFeeType is 43 and facilityTypeCode is 280', async () => {
  ...
  //   it('sets FixedFeeName to facilityTypeCode if fixedFeeType is 43 and facilityTypeCode is not 250, 260, or 280', async () => {
